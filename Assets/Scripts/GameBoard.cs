...
public class GameBoard : MonoBehaviour
{
    ...
    {
        if (isPlayerOneUp) //Usuniecie jednego zycia, poniewaz zginelismy
            livesPlayerOne -= 1;
        else
            livesPlayerTwo -= 1;
        ...
        if (livesPlayerOne == 0 && livesPlayerTwo == 0) //Jesli skonczyly nam sie zycia dodatkowe
        {
        ...
        else if (!GameMenu.isOnePlayerGame && (livesPlayerOne == 0 || livesPlayerTwo == 0)) //Jesli koniec gry dla jednego gracza
        {
            if (livesPlayerOne == 0)
            {
    ...
    */
    ...
    //funkcja do odświeżania interfejsu graficznego
